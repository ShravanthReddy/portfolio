    ...
    <div className='div-main-container'>
        ...
        <nav className='nav-bar animate-right'>
            <div className='nav-bar-items animate-down'>
                ...
                <a href="https://twitter.com/shrvnth_rdy" className='twitter-icon'>
                    <svg href='www.google.com' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                ...
                <a href="https://github.com/ShravanthReddy" className='github-icon'>
